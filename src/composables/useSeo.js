...
const SEO_CONFIG = {
  ...
  '/qr-code': {
    ...
    description: '免费在线二维码生成器，支持自定义前景色背景色、上传Logo嵌入二维码中心、调整容错等级和尺寸，生成高清二维码图片下载，无需安装软件。',
    keywords: '二维码生成器,QR码生成,在线二维码,二维码美化,二维码Logo,免费二维码,自定义二维码',
  },
  '/ocr': {
    title: '在线OCR文字识别 - 图片转文字·中英文识别 | AI Box Pro',
    description: '免费在线OCR文字识别工具，支持中英文等多语言，上传图片即可提取文字内容，纯浏览器端处理，安全无上传，识别结果可复制或下载。',
    keywords: 'OCR文字识别,图片转文字,在线OCR,文字提取,免费OCR,图片文字识别',
  },
  '/remove-bg': {
    title: '在线AI抠图工具 - 智能去除背景·一键透明背景 | AI Box Pro',
    description: '免费在线AI抠图工具，AI自动识别图片主体，精准去除背景，支持透明背景导出或自定义纯色背景替换，纯浏览器端处理，安全无上传。',
    keywords: 'AI抠图,在线抠图,去除背景,透明背景,图片抠图,免费抠图,智能抠图,背景去除',
  },
}
