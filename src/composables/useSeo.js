...
const SEO_CONFIG = {
  '/': {
    title: 'AI Box Pro - 在线AI工具箱 | 图片处理·文档转换·AI创作',
    description: 'AI Box Pro 是一款在线AI工具箱，提供AI证件照制作、图片去水印、图片压缩、文档格式转换、AI图片视频生成、屏幕录制等多种实用工具，无需下载，打开即用。',
    keywords: 'AI工具箱,在线工具,AI工具,效率工具',
  },
  '/id-photo': {
    title: '在线AI证件照制作 - 一寸二寸证件照·智能换背景色 | AI Box Pro',
    description: '在线AI证件照制作工具，支持一寸、二寸、小一寸、小二寸等标准尺寸，AI智能抠图换背景，红底蓝底白底一键切换，自定义像素尺寸，排版打印下载。',
  ...
  '/qr-code': {
    title: '在线二维码生成器 - 自定义颜色·嵌入Logo美化 | AI Box Pro',
  ...
  '/ocr': {
    title: '在线OCR文字识别 - 图片转文字·中英文识别 | AI Box Pro',
    description: '在线OCR文字识别工具，支持中英文等多语言，上传图片即可提取文字内容，纯浏览器端处理，安全无上传，识别结果可复制或下载。',
    keywords: 'OCR文字识别,图片转文字,在线OCR,文字提取,图片文字识别',
  },
  '/remove-bg': {
    title: '在线AI抠图工具 - 智能去除背景·一键透明背景 | AI Box Pro',
    description: '在线AI抠图工具，AI自动识别图片主体，精准去除背景，支持透明背景导出或自定义纯色背景替换，纯浏览器端处理，安全无上传。',
    keywords: 'AI抠图,在线抠图,去除背景,透明背景,图片抠图,智能抠图,背景去除',
  },
}
