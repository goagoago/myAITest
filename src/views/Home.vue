    ...
    <section class="hero-shell">
      ...
      <div class="hero-grid hero-grid--single">
        <div class="hero-copy hero-panel hero-panel--main">
          ...
          <p class="hero-desc">
            处理图片、文档、音视频和常用 AI 助手，不必在一堆站点之间来回跳。
          </p>
