...
import { UserPlus, User, Lock, Mail, Eye, EyeOff, ArrowLeft } from 'lucide-vue-next'
...
async function handleRegister() {
  ...
  loading.value = true
  try {
    const res = await register(form.value.username, form.value.password, form.value.email)
    if (res.success) {
      router.push('/')
    } else {
  ...
  <div class="auth-page">
    <div class="auth-card">
      ...
      <div class="auth-header">
        ...
        <p class="auth-subtitle">注册你的 AI Box 账号</p>
      </div>
      ...
      <form class="auth-form" @submit.prevent="handleRegister">
        ...
        <div class="form-group">
          <label class="form-label">邮箱 <span class="form-optional">（选填）</span></label>
          <div class="form-input-wrap">
        ...
        <div class="form-group">
          <label class="form-label">确认密码 <span class="form-required">*</span></label>
          <div class="form-input-wrap">
            <Lock :size="18" class="form-input-icon" />
            <input
