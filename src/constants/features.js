export const FEATURE_CATALOG = [
  ...
  { code: 'image-compress', name: '图片压缩', category: '图片工具', description: '按尺寸、质量或目标大小压缩图片', cost: 1 },
  { code: 'id-photo', name: '证件照制作', category: '图片工具', description: 'AI 抠图并输出标准证件照', cost: 2 },
  { code: 'remove-bg', name: 'AI 抠图', category: '图片工具', description: '自动去除图片背景并导出透明图', cost: 2 },
